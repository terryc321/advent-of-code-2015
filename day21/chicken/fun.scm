...
(define (make-player)
  (let ((weapons '((dagger 8 4 0)
    ...
    (let ((best-cost 99999999999999999999999999))
			       ...
			       (do-list (ring2 rings)
					(let* ((bag (list weapon armour ring1 ring2))
					  ...
					  (let ((opp-hits 103)(opp-dam 9)(opp-arm 2))
						...
						(when (< cost best-cost)
						  (set! best-cost cost)
						  (format #t "win - dam :~a  arm ~a : cost ~a ~%" dam arm cost)))))))))))
...
#|
win - dam :10  arm 1 : cost 221 
win - dam :9  arm 2 : cost 189 
win - dam :4  arm 8 : cost 181 
win - dam :6  arm 6 : cost 173 
win - dam :4  arm 8 : cost 163 
win - dam :9  arm 2 : cost 141 
win - dam :10  arm 1 : cost 138 
win - dam :9  arm 2 : cost 131 
win - dam :10  arm 1 : cost 128 
win - dam :9  arm 2 : cost 123 
win - dam :9  arm 2 : cost 121 
